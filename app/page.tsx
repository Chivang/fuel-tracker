...
export default function Home() {
  ...
  useEffect(() => {
    ...
    import('leaflet').then((L) => {
      const common = { iconSize: [25, 41], iconAnchor: [12, 41], popupAnchor: [1, -34], shadowSize: [41, 41], shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-shadow.png' }
      setIcons({
